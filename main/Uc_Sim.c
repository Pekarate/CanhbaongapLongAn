...
#define CONFIG_GSM_APN "E-CONNECT"
...
const char *PPP_User = "Hoang";
const char *PPP_Pass = "hoang";
...
int change_baudrate_speed(uint32_t baud)
{
	char cmd[20];
	int len = sprintf(cmd,"AT+IPR=115200;&W\r\n");
	int res = atCmd_waitResponse(cmd, GSM_OK_Str, NULL, len, 3000, NULL, 0);
	if (res == 1) {
